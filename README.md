...
- **Header breakpoints:** full desktop bar from 1280px; a compacted desktop bar (smaller nav type, phone number hidden, tighter booking button) from 1200–1279px; burger menu below 1200px (the six-item menu can't fit beside the logo, icons and booking button on narrower windows). Content sections keep their own 1024px mobile breakpoint. Search, account and cart icons are always visible at every width.
